 ...
 */
function koi_preprocess_node(&$vars) {

  if ($vars['teaser']) {
    $vars['display_title'] = '<a href="' . $vars['node_url'] . '">' . $vars['title'] . '</a>';
  }
  else {
    $vars['display_title'] = $vars['title'];
  }

  if ($vars['page']) {
    $vars['display_title'] = '<h1 class="node-title" >' . $vars['display_title'] . '</h1>';
  }
  elseif (!$vars['page']) {
    $vars['display_title'] = '<h2 class="node-title" >' . $vars['display_title'] . '</h2>';
  }
